  ...
  return (
    <div className={mainContainerClass}>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
        ...
        {/* Funcionalidades de Búsqueda y Filtro, como la imagen */}
        ...
        {/* Modal de Gestión de Solicitud (Edición) */}
        {editId && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
            <div className="bg-[#FAF0E6] p-6 rounded-lg shadow-2xl w-full max-w-lg border-t-4 border-[#A0522D]">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                {/* Notas del Administrador (Para justificar rechazos/modificaciones) */}
                <div>
        ...
        {/* Modal de Detalles del Puesto (Vista de la Descripción y Datos Personales) */}
        {artesanoDetails && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
